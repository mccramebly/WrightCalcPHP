...
<body>
    ...
    <table id="htmlcodes" border="1" cellpadding="0" cellspacing="0" summary="A listing of HTML4 character codes" width="100%">
        ...
        <tr>
            <td>&amp;#146;</td>
            <td><em>&amp;#146; is non-standard! use &amp;#8217; instead!</em></td>
            <td>&#146; use &#8217;</td>
        </tr>
        <!-- 0150-->
        <tr>
            <td>&amp;#150;</td>
            <td><em>&amp;endash; or &amp;#150; are non-standard! use &amp;#8211; instead!</em></td>
            <td>&endash; or &#150; use &#8211;</td>
        </tr>
        <!-- 0151-->
        <tr>
            <td>&amp;#151;</td>
            <td><em>&amp;emdash; or &amp;#151; are non-standard! use &amp;#8212; instead!</em></td>
            <td>&emdash; or &#151; use &#8212;</td>
        </tr>
        <!-- 0160-->
        <tr>
        ...
        <tr>
            <td>XX&amp;#772;&amp;#713;XX</td>
            <td>separate line above [not for Chrome)</td>
            <td>XX&#772;&#713;XX</td>
        </tr>
        <!-- 0772-->
        <tr>
            <td>XX&amp;#772;&amp;#175;XX</td>
            <td>combined line above [not for Chrome)</td>
            <td>XX&#772;&#175;XX</td>
        </tr>
        <!-- 0773-->
        <tr>
        ...
        <tr>
            <td>&amp;#9812;</td>
            <td>chess white king</td>
            <td>&#9812;</td>
        </tr>
        <!-- 9813-->
        <tr>
            <td>&amp;#9813;</td>
            <td>chess white queen</td>
            <td>&#9813;</td>
        </tr>
        <!-- 9814-->
        <tr>
            <td>&amp;#9814;</td>
            <td>chess white rook</td>
            <td>&#9814;</td>
        </tr>
        <!-- 9815-->
        <tr>
            <td>&amp;#9815;</td>
            <td>chess white bishop</td>
            <td>&#9815;</td>
        </tr>
        <!-- 9816-->
        <tr>
            <td>&amp;#9816;</td>
            <td>chess white knight</td>
            <td>&#9816;</td>
        </tr>
        <!-- 9817-->
        <tr>
            <td>&amp;#9817;</td>
            <td>chess white pawn</td>
            <td>&#9817;</td>
        </tr>
        <!-- 9818-->
        <tr>
            <td>&amp;#9818;</td>
            <td>chess black king</td>
            <td>&#9818;</td>
        </tr>
        <!-- 9819-->
        <tr>
            <td>&amp;#9819;</td>
            <td>chess black queen</td>
            <td>&#9819;</td>
        </tr>
        <!-- 9820-->
        <tr>
            <td>&amp;#9820;</td>
            <td>chess black rook</td>
            <td>&#9820;</td>
        </tr>
        <!-- 9821-->
        <tr>
            <td>&amp;#9821;</td>
            <td>chess black bishop</td>
            <td>&#9821;</td>
        </tr>
        <!-- 9822-->
        <tr>
            <td>&amp;#9822;</td>
            <td>chess black knight</td>
            <td>&#9822;</td>
        </tr>
        <!-- 9823-->
        <tr>
            <td>&amp;#9823;</td>
            <td>chess black pawn</td>
            <td>&#9823;</td>
        </tr>
        <!-- 9824-->
        <tr>
    ...
    <p>Add this page as a <a href="http://tntluoma.com/files/codes.htm" rel="sidebar" title="HTMLCodes">Sidebar/Panel</a></p>
