...
<head>
    ...
    <title>Wright College Smart Calculator</title>
...
<body>
    <div id="menu">
        ...
        <header>
            <h1>Wright College Smart Calculator</h1>
        </header>
        <main>
        ...
        <footer>
            <a href="bio2012.htm" class="hov">About Prof Nadas</a>
            <a href="why.htm" class="hov">About the calculator</a>
            Contact Prof Nadas:
            <a href="mailto:jnadas@ccc.edu" class="hov">jnadas@ccc.edu</a>
            <a href="http://sg.answers.yahoo.com/dir/index;_ylt=AsbT3sjR2OcKYECnd7dzOgk45Qt.;_ylv=3?sid=396545161">Yahoo Answers Mathematics</a>
        </footer>
        <div class="deco">
            <ul>
                <li>&deg;</li>
