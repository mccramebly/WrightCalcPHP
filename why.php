...
<body>
    ...
    <div class="artmenu">
        ...
        <ul>
            <li><a href="squareroot.htm?2.759" target="julius">Square Roots</a><br> using (a+b)² = a² + 2ab + b² we can calculate √2.759 like this:
...
×8=              <u> 26 57 63 79 84</u></pre>
            ...
            <li><a href="calc.htm?log(2.76)/2;10^0.2204" target="julius">Base Ten Logarithms</a> We needed to look them up in tables:<br>
                0.3010, 0.4771, 0.6021, 0.6990, 0.7782, 0.8451, 0.9031, 0.9542</li>
            log(2.76) = 0.4409; 0.4409/2 = 0.22045; antilog(0.2204) = 1.661<br><br>
            <li><a href="calc.htm?x=0.4409/0.4343;e^(x/2)" target="julius">Natural Logarithms</a> were calculated by using: ln(x) = log(x) ÷ log(<i>e</i>)<br>
    ...
    <div class="artmenu">
        ...
        <p><a href="calc.htm?N=2.759;x=2;y=x*x;y=y+N;y=y/2;x=y/x;x=(x*x+N)/2/x;x=(x*x+N)/2/x;x=(x*x+N)/2/x;x^2" target="julius">Example:</a> to take the square root of N = 2.759</p>
        <ol>
...
<strong>input</strong>
6x-3y=15
<a href="simplify.htm?6x-3y=15" target="julius"><strong>result</strong></a> 
...
<strong>input</strong>
2x -5
<a href="plot.htm?2x-5&-2&18" target="julius"><strong>result</strong></a> 
(-2.0, -9.0000)
(-1.0, -7.0000)
(0.00, -5.0000)
(1.00, -3.0000)
...
<a href="regress.htm? & & &(-2, -9), (-1, -7), (0, -5), (1, -3), (2, -1), (3, 1)" target="julius"><strong>result</strong></a> 
...
<a href="parabola.htm?(x-2)(x+3)=14" target="julius"><b>result</b></a> 
 Quadratic formula: 
...
<a href="simplify.htm?x²=2.759" target="julius"><strong>result</strong></a>
x^2 -2.759 = 0<br>Quadratic equation: x = -4121/2481 & x = 4121/2481
<a href="graphs.htm?x:-3%20to%203;y:%20-1%20to%206;y=x^2;y=2.759;x=sqrt(2.759)" target="julius"><strong>graph</strong></a> 

<strong>input</strong>
 (x-2)(x+3)=14

<a href="simplify.htm?(x-2)(x+3)=14" target="julius"><strong>result</strong></a>
 x^2 +3x -2x -6 =  14
 x^2 +x -6 =  14
 x^2 +x = 20
 x^2 +x -20 = 0
...
<a href="simplify.htm?2(3x+y)=4px+m" target="julius"><strong>result</strong></a>
 6x +2y =  4px +m
 6x +2y =  m +4px
 -m -4px +6x +2y = 0
 x=( m -2y)/( -4p +6)
    ...
    <div class="artmenu">
        ...
        <p><a href="linear.htm?x/3+0y-4z=0;y/2+15=z;z=21+y" target="julius"><strong>result</strong></a></p>
    ...
    <div class="artmenu">
        ...
        <a href="triangle.htm?sas:%2032,%2090%C2%B0,%2045" target="julius"><strong>result</strong></a>
        ...
        <a href="triangle.htm?A=33%C2%B0,%20a=4,%20b=5" target="julius"><strong>result</strong></a>
    ...
    <div class="artmenu">
        <h2>2010: Smart calculators Systems of Transcendental Equations</h2>
        ...
        <p><strong>input:</strong> x:0 to 14;y:-2 to 13;e^(x/4);4cos(x)+5 to get the <a href="graphs.htm?x:0 to 14;y:-2 to 13;e^(x/4);4cos(x)+5" target="julius"><strong>result</strong></a></p>
        <p>or you could graph the difference between the two functions and see where the difference is equal to zero:</p>
        <p><strong>input:</strong> x:0 to 14;y:-8 to 49;e^(x/4)-(4cos(x)+5) to get the <a href="graphs.htm?x:0 to 14;y:-8 to 49;e^(x/4)-(4cos(x)+5)" target="julius"><strong>result</strong></a> </p>
